...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "suho~8zsgTYgY#pUxKAjvMg1v3VBUtkaKVQuP6brJuR5UQAjOlAQ-XK5s",
...
> ɢɪᴛʜᴜʙ : github.com/NaCkS-ai/SungSu-ho-MD`,
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Mr-POWER",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50932177717",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "Mr POWER",
    // add bot owner name
    ...
    DEV: process.env.DEV || "50932177717",
